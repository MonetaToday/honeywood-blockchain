...
const getDefaultState = () => {
	return {
				...
				_Structure: {
						...
						QueryShowBeesInfoByBearIdResponse_BeeInfo: getStructure(QueryShowBeesInfoByBearIdResponse_BeeInfo.fromPartial({})),
						QueryListBearsStatisticResponse_BearsStatistic: getStructure(QueryListBearsStatisticResponse_BearsStatistic.fromPartial({})),
						QueryListAddressesStatisticResponse_AddressesStatistic: getStructure(QueryListAddressesStatisticResponse_AddressesStatistic.fromPartial({})),
...
export default {
	...
	getters: {
			...
			return state.ShowDecorationsInfoByBearId[JSON.stringify(params)] ?? {}
				...
				getShowBeesInfoByBearId: (state) => (params = { params: {}}) => {
					if (!(<any> params).query) {
						(<any> params).query=null
					}
			...
			return state.AirHistoryAll[JSON.stringify(params)] ?? {}
				...
				getListBearsStatistic: (state) => (params = { params: {}}) => {
					if (!(<any> params).query) {
						(<any> params).query=null
					}
			return state.ListBearsStatistic[JSON.stringify(params)] ?? {}
		},
				getListAddressesStatistic: (state) => (params = { params: {}}) => {
					if (!(<any> params).query) {
						(<any> params).query=null
					}
			return state.ListAddressesStatistic[JSON.stringify(params)] ?? {}
		},
	...
	actions: {
		...
		async QueryFieldsAll({ commit, rootGetters, getters }, { options: { subscribe, all} = { subscribe:false, all:false}, params, query=null }) {
			try {
				...
				while (all && (<any> value).pagination && (<any> value).pagination.next_key!=null) {
					let next_values=(await queryClient.queryFieldsAll({...query, 'pagination.key':(<any> value).pagination.next_key})).data
					value = mergeResults(value, next_values);
				}
		...
		async QueryTreesAll({ commit, rootGetters, getters }, { options: { subscribe, all} = { subscribe:false, all:false}, params, query=null }) {
			try {
				...
				while (all && (<any> value).pagination && (<any> value).pagination.next_key!=null) {
					let next_values=(await queryClient.queryTreesAll({...query, 'pagination.key':(<any> value).pagination.next_key})).data
					value = mergeResults(value, next_values);
				}
		...
		async QueryDecorationsAll({ commit, rootGetters, getters }, { options: { subscribe, all} = { subscribe:false, all:false}, params, query=null }) {
			try {
				...
				while (all && (<any> value).pagination && (<any> value).pagination.next_key!=null) {
					let next_values=(await queryClient.queryDecorationsAll({...query, 'pagination.key':(<any> value).pagination.next_key})).data
					value = mergeResults(value, next_values);
				}
		...
		async QueryApiariesAll({ commit, rootGetters, getters }, { options: { subscribe, all} = { subscribe:false, all:false}, params, query=null }) {
			try {
				...
				while (all && (<any> value).pagination && (<any> value).pagination.next_key!=null) {
					let next_values=(await queryClient.queryApiariesAll({...query, 'pagination.key':(<any> value).pagination.next_key})).data
					value = mergeResults(value, next_values);
				}
		...
		async QueryBeesAll({ commit, rootGetters, getters }, { options: { subscribe, all} = { subscribe:false, all:false}, params, query=null }) {
			try {
				...
				while (all && (<any> value).pagination && (<any> value).pagination.next_key!=null) {
					let next_values=(await queryClient.queryBeesAll({...query, 'pagination.key':(<any> value).pagination.next_key})).data
					value = mergeResults(value, next_values);
				}
		...
		async QueryShowBeesInfoByBearId({ commit, rootGetters, getters }, { options: { subscribe, all} = { subscribe:false, all:false}, params, query=null }) {
			try {
				const key = params ?? {};
				const queryClient=await initQueryClient(rootGetters)
				let value= (await queryClient.queryShowBeesInfoByBearId( key.bearId)).data
				
					
				commit('QUERY', { query: 'ShowBeesInfoByBearId', key: { params: {...key}, query}, value })
		...
		async QueryAirHistoryAll({ commit, rootGetters, getters }, { options: { subscribe, all} = { subscribe:false, all:false}, params, query=null }) {
			try {
				...
				throw new SpVuexError('QueryClient:QueryAirHistoryAll', 'API Node Unavailable. Could not perform query: ' + e.message)
		...
		async QueryListBearsStatistic({ commit, rootGetters, getters }, { options: { subscribe, all} = { subscribe:false, all:false}, params, query=null }) {
			try {
				const key = params ?? {};
				const queryClient=await initQueryClient(rootGetters)
				let value= (await queryClient.queryListBearsStatistic(query)).data
				
					
				while (all && (<any> value).pagination && (<any> value).pagination.next_key!=null) {
					let next_values=(await queryClient.queryListBearsStatistic({...query, 'pagination.key':(<any> value).pagination.next_key})).data
					value = mergeResults(value, next_values);
				}
				commit('QUERY', { query: 'ListBearsStatistic', key: { params: {...key}, query}, value })
				if (subscribe) commit('SUBSCRIBE', { action: 'QueryListBearsStatistic', payload: { options: { all }, params: {...key},query }})
				return getters['getListBearsStatistic']( { params: {...key}, query}) ?? {}
			} catch (e) {
				throw new SpVuexError('QueryClient:QueryListBearsStatistic', 'API Node Unavailable. Could not perform query: ' + e.message)
		...
		async QueryListAddressesStatistic({ commit, rootGetters, getters }, { options: { subscribe, all} = { subscribe:false, all:false}, params, query=null }) {
			try {
				const key = params ?? {};
				const queryClient=await initQueryClient(rootGetters)
				let value= (await queryClient.queryListAddressesStatistic(query)).data
				
					
				while (all && (<any> value).pagination && (<any> value).pagination.next_key!=null) {
					let next_values=(await queryClient.queryListAddressesStatistic({...query, 'pagination.key':(<any> value).pagination.next_key})).data
					value = mergeResults(value, next_values);
				}
				commit('QUERY', { query: 'ListAddressesStatistic', key: { params: {...key}, query}, value })
				if (subscribe) commit('SUBSCRIBE', { action: 'QueryListAddressesStatistic', payload: { options: { all }, params: {...key},query }})
				return getters['getListAddressesStatistic']( { params: {...key}, query}) ?? {}
			} catch (e) {
				throw new SpVuexError('QueryClient:QueryListAddressesStatistic', 'API Node Unavailable. Could not perform query: ' + e.message)
