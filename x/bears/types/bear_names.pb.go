...
type BearNames struct {
	...
	BearId string `protobuf:"bytes,2,opt,name=bearId,proto3" json:"bearId,omitempty"`
}
...
func (m *BearNames) GetBearId() string {
	if m != nil {
		return m.BearId
	}
	return ""
...
var fileDescriptor_1d67ef60f6cadd79 = []byte{
	...
	0x9c, 0x41, 0x60, 0xb6, 0x90, 0x18, 0x17, 0x1b, 0x48, 0xa5, 0x67, 0x8a, 0x04, 0x13, 0x58, 0x14,
	...
	0xcc, 0x92, 0x8c, 0xd2, 0x24, 0xbd, 0xe4, 0xfc, 0x5c, 0x7d, 0x24, 0xab, 0xf5, 0x3d, 0x40, 0x56,
	0x87, 0xe7, 0xe7, 0xa7, 0xe8, 0x57, 0xe8, 0x43, 0x9c, 0x5a, 0x52, 0x59, 0x90, 0x5a, 0x9c, 0xc4,
	0x06, 0x76, 0xa6, 0x31, 0x20, 0x00, 0x00, 0xff, 0xff, 0x71, 0xda, 0xdd, 0x04, 0xc0, 0x00, 0x00,
	0x00,
}
...
func (m *BearNames) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.BearId) > 0 {
		i -= len(m.BearId)
		copy(dAtA[i:], m.BearId)
		i = encodeVarintBearNames(dAtA, i, uint64(len(m.BearId)))
		i--
		dAtA[i] = 0x12
	}
	if len(m.Name) > 0 {
...
func (m *BearNames) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			m.BearId = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
