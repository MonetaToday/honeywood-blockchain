...
func (m *Trees) GetPlaceId() uint64 {
	if m != nil {
		return m.PlaceId
	}
	return 0
...
func (m *Trees) GetGroundId() uint64 {
	if m != nil {
		return m.GroundId
	}
	return 0
...
var fileDescriptor_a7453a7001a729ab = []byte{
	...
	0x2c, 0xcf, 0xcf, 0x4f, 0xd1, 0x03, 0x2b, 0x54, 0x4a, 0xe5, 0x62, 0x0d, 0x01, 0xa9, 0x15, 0xe2,
	0xe3, 0x62, 0xca, 0x4c, 0x91, 0x60, 0x54, 0x60, 0xd4, 0x60, 0x09, 0x62, 0xca, 0x4c, 0x11, 0x12,
	0xe3, 0x62, 0x03, 0xa9, 0xf0, 0x4c, 0x91, 0x60, 0x02, 0x8b, 0x41, 0x79, 0x42, 0x12, 0x5c, 0xec,
	0x05, 0x39, 0x89, 0xc9, 0xa9, 0x9e, 0x29, 0x12, 0xcc, 0x60, 0x09, 0x18, 0x57, 0x48, 0x8a, 0x8b,
	0x23, 0xbd, 0x28, 0xbf, 0x34, 0x2f, 0xc5, 0x33, 0x45, 0x82, 0x05, 0x2c, 0x05, 0xe7, 0x3b, 0x79,
	...
	0x69, 0x92, 0x5e, 0x72, 0x7e, 0xae, 0x3e, 0x92, 0x43, 0xf5, 0x3d, 0x40, 0x0e, 0x0d, 0xcf, 0xcf,
	0x4f, 0xd1, 0xaf, 0xd0, 0x87, 0xfa, 0xa9, 0xb2, 0x20, 0xb5, 0x38, 0x89, 0x0d, 0xec, 0x29, 0x63,
	0x40, 0x00, 0x00, 0x00, 0xff, 0xff, 0x4a, 0xd4, 0x25, 0xa6, 0xe9, 0x00, 0x00, 0x00,
}
...
func (m *Trees) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	if m.GroundId != 0 {
		i = encodeVarintTrees(dAtA, i, uint64(m.GroundId))
		i--
		dAtA[i] = 0x20
	}
	if m.PlaceId != 0 {
		i = encodeVarintTrees(dAtA, i, uint64(m.PlaceId))
		i--
		dAtA[i] = 0x18
	}
	if m.BearId != 0 {
...
func (m *Trees) Size() (n int) {
	...
	if m.PlaceId != 0 {
		n += 1 + sovTrees(uint64(m.PlaceId))
	}
	if m.GroundId != 0 {
		n += 1 + sovTrees(uint64(m.GroundId))
	}
	return n
}
