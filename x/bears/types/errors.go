...
var (
	...
	ErrBeeTypeIsNotDefined        = sdkerrors.Register(ModuleName, 23, "Bee type is not defined")
	ErrBeeIsNotExisted            = sdkerrors.Register(ModuleName, 24, "Bee is not existed")
	ErrBeeIsInApiaryHouse         = sdkerrors.Register(ModuleName, 25, "Bee is already in apiary house")
	ErrBeeIsNotInApiaryHouse      = sdkerrors.Register(ModuleName, 26, "Bee is not in apiary house yet")
)
