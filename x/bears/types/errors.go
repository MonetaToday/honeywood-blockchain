...
var (
	...
	ErrDecorationTypeIsNotDefined   = sdkerrors.Register(ModuleName, 18, "Decoration type is not defined")
	ErrApiaryTypeIsNotDefined   = sdkerrors.Register(ModuleName, 19, "Apiary type is not defined")
	ErrApiaryIsNotExisted       = sdkerrors.Register(ModuleName, 20, "Apiary is not existed")
)
