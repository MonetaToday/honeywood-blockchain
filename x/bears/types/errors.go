...
var (
	...
	ErrFieldHasNoTileId       = sdkerrors.Register(ModuleName, 9, "There is no tileId in this field")
	ErrTileIsNotEmpty         = sdkerrors.Register(ModuleName, 10, "There is already something on the tile")
	ErrItemIsNotExistedOnTile = sdkerrors.Register(ModuleName, 11, "Item is not existed on the tile")
