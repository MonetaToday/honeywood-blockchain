...
func GetQueryCmd(queryRoute string) *cobra.Command {
	...
	cmd.AddCommand(CmdShowHoneyPowerByBearId())

	cmd.AddCommand(CmdShowTreesInfoByBearId())

	cmd.AddCommand(CmdShowDecorationsInfoByBearId())

	cmd.AddCommand(CmdShowBeesInfoByBearId())

	cmd.AddCommand(CmdListAirHistory())

	cmd.AddCommand(CmdListBearsStatistic())

	cmd.AddCommand(CmdListAddressesStatistic())
